    ...
    public class ReaderWriterLockSlim : IDisposable
    {
        ...
        private bool TryEnterReadLockCore(int millisecondsTimeout)
        {
            ...
            if (!fIsReentrant)
            {
                ...
                {
                    //Check for AW->AR
                    return false;// throw new LockRecursionException(SR.GetString(SR.LockRecursionException_ReadAfterWriteNotAllowed));
                }
                ...
                if (lrwc.readercount > 0)
                {
                    ...
                    ExitMyLock();
                    return false;//throw new LockRecursionException(SR.GetString(SR.LockRecursionException_RecursiveReadNotAllowed));
                }
        ...
        private bool TryEnterWriteLockCore(int millisecondsTimeout)
        {
            ...
            if (!fIsReentrant)
            {
                ...
                {
                    //Check for AW->AW
                    return false;//throw new LockRecursionException(SR.GetString(SR.LockRecursionException_RecursiveWriteNotAllowed));
                }
                else if (id == upgradeLockOwnerId)
                {
                ...
                {
                    ExitMyLock();
                    return false;//throw new LockRecursionException(SR.GetString(SR.LockRecursionException_WriteAfterReadNotAllowed));
                }
            }
            else
            {
        ...
        private bool TryEnterUpgradeableReadLockCore(int millisecondsTimeout)
        {
            ...
            if (!fIsReentrant)
            {
                ...
                {
                    //Check for AU->AU 
                    return false;//throw new LockRecursionException(SR.GetString(SR.LockRecursionException_RecursiveUpgradeNotAllowed));
                }
                else if (id == writeLockOwnerId)
                {
                    //Check for AU->AW
                    return false;//throw new LockRecursionException(SR.GetString(SR.LockRecursionException_UpgradeAfterWriteNotAllowed));
                }
                ...
                {
                    ExitMyLock();
                    return false;//throw new LockRecursionException(SR.GetString(SR.LockRecursionException_UpgradeAfterReadNotAllowed));
                }
            }
            else
            {
        ...
        public void ExitReadLock()
        {
            ...
            if (!fIsReentrant)
            {
                if (lrwc == null)
                {
                    ...
                    ExitMyLock();
                    return ;//throw new SynchronizationLockException(SR.GetString(SR.SynchronizationLockException_MisMatchedRead));
                }
            }
            else
            {
        ...
        public void ExitWriteLock()
        {
            ...
            if (!fIsReentrant)
            {
                if (id != writeLockOwnerId)
                {
                    ...
                    return;//throw new SynchronizationLockException(SR.GetString(SR.SynchronizationLockException_MisMatchedWrite));
                }
                EnterMyLock();
            }
            else
        ...
        public void ExitUpgradeableReadLock()
        {
            ...
            if (!fIsReentrant)
            {
                if (id != upgradeLockOwnerId)
                {
                    ...
                    return;//throw new SynchronizationLockException(SR.GetString(SR.SynchronizationLockException_MisMatchedUpgrade));
                }
                EnterMyLock();
            }
            else
        ...
        private void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                if (WaitingReadCount > 0 || WaitingUpgradeCount > 0 || WaitingWriteCount > 0)
                    return;//throw new SynchronizationLockException(SR.GetString(SR.SynchronizationLockException_IncorrectDispose));
